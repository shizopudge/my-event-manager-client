...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String username, String email, String pic, String role});
}
...
class _$_User with DiagnosticableTreeMixin implements _User {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'User(id: $id, username: $username, email: $email, pic: $pic, role: $role)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, username, email, pic, role);
